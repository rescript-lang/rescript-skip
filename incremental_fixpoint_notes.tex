...
\item \textbf{Contraction} ($K^* = S'$): The direction $S' \subseteq K^*$ is proven assuming count is \emph{monotone} in its set argument. The reverse $K^* \subseteq S'$ remains future work.
\end{itemize}
