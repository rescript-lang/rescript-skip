...
A catalogue of 48 representative examples---including DBToaster-style
...
absent from all 48 examples---not because they are rare, but because
Skip cannot express them.
...
We identify \textsf{filterNotMatchingOn} as the missing operator,
...
Examining 48 representative reactive service examples, we find that
...
We identify $\mathsf{filterNotMatchingOn}$ as the single missing operator,
...
The 48-example catalogue contains no ``NOT IN'' style queries,
